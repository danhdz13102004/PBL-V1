          ...
          <div class="form-signup">
            ...
            <form action="${pageContext.request.contextPath}/khach-hang/dang-ki" method="post" target="_self" class="form" id="form">
              ...
              <div class="form-field">
                ...
                <div class="form__eye">
                  <svg id="form__eye-hide-password" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                  ...
                  <svg id="form__eye-show-password" class="hidden" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
