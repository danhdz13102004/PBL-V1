    ...
    .then(data => {
        ...
        data.forEach(item => {
            ...
            <li class="category-item">
                  <span onclick="changePage(1,8,'none','${item.id}')"  class="category-item__link category-item--active theloai${item.id}">${item.ten}</span>
                </li>	
            `;
        })
    ...
    .then(data => {
        ...
        if(html1 === "") {
          ...
          <div class="checkout-default__address">
            <label for="">Địa chỉ: </label>
            <span>
              Số 121 Nguyễn Chánh, Thị Trấn Phú Thịnh, Huyện Phú Ninh, Quảng Nam
            </span>
          </div>`;
          html2 += `<div class="checkout-history__option">
          <input type="radio" name="chooseDefault" class="checkout-radio-choose-default"
          ...
          <div class="checkout-history__action">
            <button class="button checkout-history__action-edit">
              ...
              <span class="checkout-history__action-edit-label">Cập nhật</span>
              <input class="inp-id" type="hidden" value="DC00000014">
            </button>
          </div>
        </div>`;
        }
        ...
        // document.querySelector('.checkout-default__item').innerHTML = html1;
