		...
		<div class="container">
			<div class="row">
				...
				<main class="col-md-7">
					...
					<div class="mb-4">
						<c:choose>
							<c:when test="${requestScope.product.ctGiamGia.mucGiam == 0}">
							...
							<c:otherwise>
								<span class="price h4"> <fmt:formatNumber pattern="#,##0"
										value="${requestScope.product.giaBan * (100 - requestScope.product.ctGiamGia.mucGiam) / 100}" />₫
								</span>
								...
								<span class="ms-2 badge bg-info"> -<fmt:formatNumber
										pattern="#,##0" value="${requestScope.product.ctGiamGia.mucGiam}" />%
								</span>
							</c:otherwise>
						</c:choose>
					</div>
