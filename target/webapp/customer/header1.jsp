<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <% String paramName = (String)request.getAttribute("textsearch"); 
            ...
            <div class="col-lg-5">
              <div class="header-search-bar">
                <div class="header-search-bar__input">
                  <input type="search" name="query" value="<%= paramName %>" class="header-search-bar__input-field"
              ...
              <div class="header-menu">
                <ul class="header-menu__list">
                  ...
                  <li class="header-menu__item display-block">
                    <div id="cart" class="header-menu__wrap display-block">
                      <svg id="header-cart__icon" class="header-menu__icon display-block" viewBox="0 0 24 24"
                      ...
                      <div class="header-cart__notice">0</div>
	                          ...
	                          <ul class="header-cart__table">
		                            <li class="header-cart__item">
		                              ...
		                              <div class="header-cart__item-info">
		                                <div class="header-cart__item-name">Một Thoáng Ta Rực Rỡ Ở Nhân Gian Một Thoáng Ta Rực Rỡ Ở Nhân Gian Một Thoáng Ta Rực Rỡ Ở Nhân Gian</div>
                  ...
                  <li class="header-menu__item display-block">
                    ...
                    <div class="button__wrap">
                      <a id="btnSignup" class="button btnSignUp" href="${pageContext.request.contextPath}/customer/signup.jsp" ">Đăng ký</a>
                      <a id="btnLogin" role="button" class="button btnSignIn" href="${pageContext.request.contextPath}/customer/signin.jsp">Đăng nhập</a>
                    </div>
                    </c:if>
                    <!-- ? Đã đăng nhập -->
                    <c:if test="${not empty sessionScope.khachHang}">
