...
<title>Insert title here</title>
  ...
  <link rel="stylesheet" href="../css/cartdetail.css">
    <script type="module" src="../js/cartdetail.js" defer></script>
    <style type="text/css">
    	.button.btn-invalid {
    		cursor: not-allowed;
    		pointer-events: none;
          ...
          <div class="col-lg-12">
            <div class="main__wrap">
              <div class="main__title">
                <h1 class="main__title-content">Giỏ hàng</h1>
              </div>
              <div class="main__form" action="" method="" target="">
                <div class="row">
                 <!--  <div class="col-lg-12">
                    <div class="cart-empty">
                      ...
                      <a href="index.html" class="button" id="btnReturnHome">VỀ TRANG CHỦ</a>
                    </div>
                  </div> -->
                  <div class="col-lg-9">
                  	<input type="hidden" class="sub_total_inp"> 
                    <div class="cart-detail-product__header">
                      <label for="cart-detail-product__header-checkBoxAll" class="cart-detail-product__header-info">
                        <input onchange="checkBoxAllEvent(this)" type="checkbox" name="" class="cart-detail-product__checkbox all_checkbox"
                          id="cart-detail-product__header-checkBoxAll">
                        <span class="cart-detail-product__header-text">Tất cả </span>
                      </label>
                      <span class="cart-detail-product__header-unitPrice">Đơn giá</span>
                      <span class="cart-detail-product__header-quantity">Số lượng</span>
                      <span class="cart-detail-product__header-totalAmount">Thành tiền</span>
                    ...
                    <div class="cart-detail-product__body">
                      <!-- <div class="cart-detail-product__item">
                        <div for="cart-detail-product__item-checkBox" class="cart-detail-product__item-info">
                          ...
                          <div class="cart-detail-product__item-image-wrap">
                            <a href="" class="cart-detail-product__item-image"
                              style="background-image: url(../data/Cay_cam_ngot_cua_toi.jpg);">
                            </a>
                          </div>
                        ...
                        <div>
	                        <span class="cart-detail-product__item-unitPrice">86.800đ</span>
	                        <span style="padding-left: 8px" class="product-item__old-price">100.000đ</span>
                        </div>
                        <div class="cart-detail-product__item-quantity">
                          <button class="button" id="btnDecrease">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M6 12L18 12" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            </svg>
                          </button>
                          <input type="text" name="item-quantity" id="item-quantity" value="1" readonly>
                          <button class="button" id="btnIncrease">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="cart-detail-product__item-totalAmount">86.800đ</span>
                        <button class="button" id="btnDelete">
                          <svg class="cart-detail-product__btnDelete-icon" id="cart-detail-product__header-btnDelete"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                      ...
                      <div class="cart-detail-product__item">
                        ...
                        <div class="cart-detail-product__item-quantity">
                          ...
                          <input type="number" name="item-quantity" id="item-quantity" value="2">
                          <button class="button" id="btnIncrease">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                  ...
                  <div class="col-lg-3">
                    <div class="payment">
                      <div class="payment-info">
                        <span class="payment-info__subtotal">Tạm tính</span>
                        <span class="payment-info__subtotal-result">10.000.000đ</span>
                        <span class="payment-info__shipping-cost">Phí vận chuyển</span>
                        <span class="payment-info__shipping-cost-result">15.000đ</span>
                        <span class="payment-info__total">Thành tiền</span>
                        <span class="payment-info__total-result">10.000.000đ</span>
                      </div>
                      <a href="${pageContext.request.contextPath}/customer/checkout.jsp" class="button btn-invalid" id="btnToPaymentPage">
                        Thanh toán
                      </a>
                    </div>
                  </div>
