        ...
        <div class="tile">
          ...
          <div class="tile-body">
            <div class="row element-button">
             ...
             <form action="/nvql-controller/addNewProduct" method="post" enctype="multipart/form-data" class="row"> 
             <div class="row">
              <div class="form-group col-md-3">
                <label class="control-label">Tên sản phẩm</label>
                <input onchange="onchangeInput('.tensanpham',this)" name="tensanpham" class="form-control" type="text" required>
              </div>


              <div class="form-group  col-md-3">
                <label class="control-label">Số lượng</label>
                <input onchange="onchangeInput('.soluong',this)" name="soluong" class="form-control" type="number" required>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Số trang</label>
                <input onchange="onchangeInput('.sotrang',this)" name="sotrang" class="form-control" type="number" placeholder="" required>
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <input onchange="onchangeInput('.giaban',this)" name="giaban" class="form-control" type="text" required>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Giá gốc</label>
                <input onchange="onchangeInput('.giavon',this)"  name="giavon" class="form-control" type="text" required>
              </div>

              <!-- <div class="form-group col-md-3">
                <label class="control-label">Phần trăm giảm giá</label>
                <input onchange="onchangeInput('.giamgia',this)"  min="0" max="100" name="giamgia" class="form-control" type="number" placeholder="0 đến 100" required>
              </div> -->
              ...
              <div class="form-group col-md-12">
               <label class="control-label">Ảnh sản phẩm</label>
                <div id="myfileupload">
<!--                 	 <form action="/nvql-controller/addNewProduct" method="post" enctype="multipart/form-data" class="row">
						<input type="hidden" class="tensanpham" name="tensanpham" value="1">
			        	<input type="hidden" class="soluong"  name="soluong" value="1">
			        	<input type="hidden" class="sotrang" name="sotrang" value="1">
			        	<input type="hidden" class="category" name="category" value="1">
			        	<input type="hidden" class="producer" name="producer" value="1">
			        	<input type="hidden" class="author" name="author" value="1">
			        	<input type="hidden" class="giaban" name="giaban" value="1">
			        	<input type="hidden" class="giavon" name="giavon" value="1">
			        	<input type="hidden" class="giamgia" name="giamgia" value="1">
			        	<input type="hidden" class="mota" name="mota" value="1">
...
<!--                 <div id="thumbbox">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea onchange="onchangeInput('.mota',this)" class="form-control" name="mota" id="mota"></textarea>
          ...
          <div class="row">
            <div class="form-group  col-md-12">
              <span class="thong-tin-thanh-toan">
                <h5>Thêm mới tác giả</h5>
              </span>
            </div>
            <div class="form-group col-md-12">
              <label class="control-label">Nhập tên tác giả</label>
              <input class="form-control inp-author" type="text" required>
            </div>
          </div>
          <BR>
          <button onclick="addAuthor()" class="btn btn-save" type="button">Lưu lại</button>
          <a class="btn btn-cancel btn-cancel1" data-dismiss="modal" href="#">Hủy bỏ</a>
          <BR>
        </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <input class="form-control inp-category" type="text" required>
            </div>
            <!-- <div class="form-group col-md-12">
          ...
          <BR>
          <button onclick="addCategory()" class="btn btn-save" type="button">Lưu lại</button>
          <a class="btn btn-cancel btn-cancel2" data-dismiss="modal" href="#">Hủy bỏ</a>
          <BR>
        </div>
        <div class="modal-footer">
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group col-md-12">
              <label class="control-label">Nhập tên nhà xuất bản</label>
              <input class="form-control inp-producer" type="text" required>
            </div>
          </div>
          <BR>
          <button onclick="addProducer()"  class="btn btn-save" type="button">Lưu lại</button>
          <a class="btn btn-cancel btn-cancel3" data-dismiss="modal" href="#">Hủy bỏ</a>
          <BR>
        </div>
        <div class="modal-footer">
        </div>
