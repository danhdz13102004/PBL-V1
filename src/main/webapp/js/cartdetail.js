  ...
  .then(data => {
          data.forEach(item => {
              if(item.soLuong > 0) {
                  ...
                  total += giaSauGiamGia * item.sach.soLuong;
                  ...
                  <div class="cart-detail-product__item-quantity">
                    ...
                    <input type="text" name="item-quantity" id="item-quantity" value="${item.sach.soLuong}" readonly>
                  ...
                  <span class="cart-detail-product__item-totalAmount">${formatCurrency(item.sach.soLuong * giaSauGiamGia)}</span>
          ...
          var container =  document.querySelector(".main-cart-item");
