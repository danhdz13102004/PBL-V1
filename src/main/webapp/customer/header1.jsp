          ...
          <div class="row">
            ...
            <div class="col-lg-5">
              <div class="header-search-bar">
                ...
                <button onclick="changePage(1,4)" type="submit" aria-label="search" class="button header-search-bar__btn">
                ...
                <ul class="header-menu__list">
                  ...
                  <li class="header-menu__item display-block">
                    ...
                    <div class="button__wrap">
                      <a class="button btnSignUp" href="signup.html" target="_blank">Đăng ký</a>
                    ...
                    <div class="header-menu__wrap display-block">
                      ...
                      <div class="header-user__wrap">
                        <div class="header-user__list">
                          ...
                          <a href="${pageContext.request.contextPath}" id="header-user__logout" class="header-user__option">
